...
/// 
/// This is a copy of the OVR Player Controller class, with the CharacterController swapped out with the ManateeCharacterController.
/// This swap is built to allow for movement without gravity.
/// 
/// </summary>
[RequireComponent(typeof(ManateeCharacterController))]
public class ManateeOVRPlayerController : MonoBehaviour
{
	/// <summary>
	...
	protected ManateeCharacterController Controller = null;
	...
	void Awake()
	{
		Controller = gameObject.GetComponent<ManateeCharacterController>();

		if (Controller == null)
			Debug.LogWarning("OVRPlayerController: No ManateeCharacterController attached.");
